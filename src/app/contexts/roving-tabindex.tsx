  ...
  return (
    ...
    >
      <Component
        ...
        onFocus={e => {
          props?.onFocus?.(e);
          // Focus should be from this wrapper, not bubbled up from children
          if (e.target !== e.currentTarget || isShiftTabbing) return;
          const orderedItems = getOrderedItems();
          if (orderedItems.length === 0) return;

          // We focus on the first element in the roving group if focusableId is null
          if (focusableId != null) {
        ...
        // onBlur runs when user click shitf+tab, we reset the isShiftTabbing state
        onBlur={e => {
          props?.onBlur?.(e);
